...
bool delimited_input::definite() const noexcept {
  return __delimiter.definite;
}

delimited_input::segment delimited_input::delimit(size_t length) noexcept {
...
size_t delimited_input::getn(unsigned char* optr, size_t len) {
  size_t avail = __in.getn(optr, __available(len));
