...
void test_encode_class_universal(TestState& test) {
  ...
  tag_encode({ tc_universal, 0, ts_primitive, 0 }, out);
...
void test_encode_class_application(TestState& test) {
  ...
  tag_encode({ tc_application, 0, ts_primitive, 0 }, out);
...
void test_encode_class_context_specific(TestState& test) {
  ...
  tag_encode({ tc_context_specific, 0, ts_primitive, 0 }, out);
...
void test_encode_class_private(TestState& test) {
  ...
  tag_encode({ tc_private, 0, ts_primitive, 0 }, out);
...
void test_encode_constructed_definite(TestState& test) {
  ...
  tag_encode({ tc_universal, 0, ts_constructed_definite, 0 }, out);
...
void test_encode_constructed_indefinite(TestState& test) {
  ...
  tag_encode({ tc_universal, 0, ts_constructed_indefinite, 0 }, out);
...
void test_encode_max_low_number(TestState& test) {
  ...
  tag_encode({ tc_universal, 30, ts_primitive, 0 }, out);
...
void test_encode_min_high_number(TestState& test) {
  ...
  tag_encode({ tc_universal, 31, ts_primitive, 0 }, out);
...
void test_encode_max_high_number(TestState& test) {
  ...
  tag_encode({ tc_universal, numeric_limits<tag_number>::max(), ts_primitive, 0 }, out);
...
void test_encode_max_short_length(TestState& test) {
  ...
  tag_encode({ tc_universal, 0, ts_primitive, 127 }, out);
...
void test_encode_min_long_length(TestState& test) {
  ...
  tag_encode({ tc_universal, 0, ts_primitive, 128 }, out);
...
void test_encode_max_long_length(TestState& test) {
  ...
  tag_encode({ tc_universal, 0, ts_primitive, numeric_limits<size_t>::max() }, out);
