...
constexpr unsigned long tn_eoc = 0;

constexpr unsigned long tn_boolean = 1;

constexpr unsigned long tn_integer = 2;

constexpr unsigned long tn_bit_string = 3;

constexpr unsigned long tn_octet_string = 4;

constexpr unsigned long tn_null = 5;

constexpr unsigned long tn_object_ident = 6;

constexpr unsigned long tn_object_descr = 7;

constexpr unsigned long tn_external = 8;

constexpr unsigned long tn_real = 9;

constexpr unsigned long tn_enumerated = 10;

constexpr unsigned long tn_emb_pdv = 11;

constexpr unsigned long tn_utf8_string = 12;

constexpr unsigned long tn_reloid = 13;

constexpr unsigned long tn_time = 14;

constexpr unsigned long tn_sequence = 16;

constexpr unsigned long tn_set = 17;

constexpr unsigned long tn_num_string = 18;

constexpr unsigned long tn_print_string = 19;

constexpr unsigned long tn_t61_string = 20;

constexpr unsigned long tn_vtex_string = 21;

constexpr unsigned long tn_ia5_string = 22;

constexpr unsigned long tn_utc_time = 23;

constexpr unsigned long tn_gen_time = 24;

constexpr unsigned long tn_graph_string = 25;

constexpr unsigned long tn_vis_string = 26;

constexpr unsigned long tn_gen_string = 27;

constexpr unsigned long tn_univ_string = 28;

constexpr unsigned long tn_char_string = 29;

constexpr unsigned long tn_bmp_string = 30;

constexpr unsigned long tn_date = 31;

constexpr unsigned long tn_timeofday = 32;

constexpr unsigned long tn_datetime = 33;

constexpr unsigned long tn_duration = 34;

constexpr unsigned long tn_oidiri = 35;

constexpr unsigned long tn_reloidiri = 36;
